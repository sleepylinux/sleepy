...
assert_contains "$locker_module" 'Restart = "always"'
assert_contains "$locker_module" 'StartLimitIntervalSec = 10'
assert_contains "$locker_module" 'StartLimitBurst = 3'
assert_contains "$locker_module" 'RestartSec = "250ms"'
