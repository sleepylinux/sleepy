...
assert_contains "$locker_module" 'After = ["graphical-session.target" "sleepy-runtime.service"]'
assert_contains "$locker_module" 'Requires = ["sleepy-runtime.service"]'
assert_contains "$locker_module" 'RuntimeDirectoryPreserve = "yes"'
