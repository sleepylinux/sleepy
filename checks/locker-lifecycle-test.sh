...
assert_contains "$locker_module" 'ExecStop = "${config.sleepy.lockerPackage}/bin/sleepy-locker-control --pid $MAINPID"'
assert_contains "$locker_module" 'TimeoutStopSec = 5'
