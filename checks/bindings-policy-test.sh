...
assert_rejected absolute-systemctl generated 'Mod+X { spawn "/run/current-system/sw/bin/systemctl" "reboot"; }'
assert_rejected store-systemctl generated 'Mod+X { spawn "/nix/store/hash-systemd/bin/systemctl" "poweroff"; }'
assert_rejected absolute-reboot generated 'Mod+X { spawn "/sbin/reboot"; }'
